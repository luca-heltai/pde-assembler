#ifndef LINEAR_QUASI_STATIC_PROBLEM_H
#define LINEAR_QUASI_STATIC_PROBLEM_H
...
class LinearQuasiStaticProblem : public dealii::ParameterAcceptor, public PDEHandlerAccess<dim,spacedim,LAC>
{
public:
  LinearQuasiStaticProblem(const std::string &name,
...
#endif // LinearQuasiStaticProblem_H
