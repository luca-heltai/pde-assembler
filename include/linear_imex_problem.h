#ifndef LINEAR_IMEX_PROBLEM_H
#define LINEAR_IMEX_PROBLEM_H
...
/**
 * Linear implicit-explicit problem.
 *
 * It expects a PDEBaseInterface that constructs the residuals based on the solution at
 * the previous iteration (the explicit solution), and the current solution.
 *
 * The interface should define two vectors, the first of which is implicit.
 */
template<int dim, int spacedim, typename LAC>
class LinearIMEXProblem : public dealii::ParameterAcceptor, public PDEHandlerAccess<dim,spacedim,LAC>
{
public:
  LinearIMEXProblem(const std::string &name,
