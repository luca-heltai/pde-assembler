...
public:
  ...
  solver_should_restart(const double t,
...
private:
  ...
  template<int odim=dim>
  typename std::enable_if<(odim>1)>::type refine_and_transfer_solutions (LADealII::VectorType &y,
  ...
  template<int odim=dim>
  typename std::enable_if<(odim>1)>::type  refine_and_transfer_solutions (LATrilinos::VectorType &y,
  ...
  refine_and_transfer_solutions (typename LAC::VectorType &,
...
template<int odim>
typename std::enable_if<(odim==1)>::type
piDoMUS<dim, spacedim, LAC>::refine_mesh ()
{
...
template <int odim>
typename std::enable_if<(odim==1)>::type
piDoMUS<dim, spacedim, LAC>::refine_and_transfer_solutions (typename LAC::VectorType &,
                                                            typename LAC::VectorType &,
                                                            typename LAC::VectorType &,
                                                            typename LAC::VectorType &,
                                                            typename LAC::VectorType &,
