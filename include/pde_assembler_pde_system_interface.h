#ifndef pde_assembler_pde_system_interface_h
#define pde_assembler_pde_system_interface_h
 ...
 * PDEAssemblerPDESystemInterface::energies_and_residuals(), which can be a templated
...
class PDEAssemblerPDESystemInterface : public PDEBaseInterface<dim,spacedim,LAC>
{


public:

  virtual ~PDEAssemblerPDESystemInterface() {}
  ...
  {
    PDEBaseInterface<dim,spacedim,LAC>::declare_parameters(prm);
  }
